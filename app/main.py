...
from .core.errors import http_422_error_handler, http_error_handler,custom_http_error_handler
...
app.add_exception_handler(CustomHTTPException, custom_http_error_handler)
