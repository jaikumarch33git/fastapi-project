...
async def custom_http_error_handler(request: Request,exc: CustomHTTPException) -> JSONResponse:
    errors = {"body": []}
    ...
    return JSONResponse({"details":exc.detail}, status_code=exc.status_code)